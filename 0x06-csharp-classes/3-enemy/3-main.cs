...
class Program
{
    static void Main(string[] args)
    {
        ...
        try
        {
            newObject3 = new Enemies.Zombie();
            Console.WriteLine("newObject3 is of type {0} and has a total of {1} health", newObject3.GetType(), newObject3.GetHealth());
        }
        catch (Exception e)
        {
            Console.WriteLine(e.Message);
